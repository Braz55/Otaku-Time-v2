...
const dictionary: Record<string, string> = {
  ...
  "Esta funcionalidade estará disponível em breve! Fica atento às próximas novidades do Otaku Time.": "This feature will be available soon! Stay tuned for the upcoming Otaku Time updates.",
  ...
  "My List": "My List",
  "Listas": "Lists",
  "Adicionar às Listas": "Add to Lists",
  "GERIR NAS LISTAS": "MANAGE IN LISTS",
  "Agenda": "Agenda",
  "Me": "Me",
  ...
  "Novo Episódio": "New Episode",
  "Novo Capítulo": "New Chapter",
  "Novidade": "New Release",
